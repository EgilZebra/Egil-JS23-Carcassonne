...
if (canvas) {
    ...
    if (ctx) {
                ...
                if (connection.type == 'R') {
                    ...
                    connection.span.forEach((tile) => {
                        ...
                        directions.forEach(({ dx, dy }) => {
                            ...
                            if (connection.span.some(c => c.col == newCol && c.row == newRow)) {
                                surroundTiles++;
                            }
                        });
                        ...
                        else if (types == surroundTiles
                            && !roadConnect) {
                            singelRoadTiles++;
                            console.log(singelRoadTiles);
                        }
                    });
                    if (singelRoadTiles == 2
        ...
        const claimConnection = (type, direction, tile) => {
            let Claimed = false;
            const directions = {
            ...
            connectedTiles.forEach((connection) => {
                ...
                if (direction !== 'centre'
                    ...
                    if ((connection.type == type && !connection.span.some(c => c.col == tile.col && c.row == tile.row))
                        || (connection.type !== type)) {
