...
*
*/
export const countPoints = (finishedConnections, allPlayersStats, gameMap, placedMeeples) => {
    ...
    finishedConnections.forEach((connection) => {
        ...
        placedMeeples.forEach((meeple, index) => {
            if (connection.span.some(t => t.col == Math.floor(meeple.col / 145) && t.row == Math.floor(meeple.row / 145))) {
