...
export const checkConnections = (newTile: TileCordinates, checkTile: TileCordinates, type: string, connections: Array<Connection>, gameMap: Tile[][], connectedTiles: Connection[]) => {
        ...
        connections.forEach((connection) => {
            ...
            if (
                ...
                if ( gameMap[checkTile.col][checkTile.row].cityConnect == true || typeNumberCheckTile.length == 1 ) {
                    ...
                    gameMap[checkTile.col][checkTile.row].cityConnect == false 
