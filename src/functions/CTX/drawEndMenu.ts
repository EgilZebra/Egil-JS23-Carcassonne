...
*
*/
export const drawEndMenu = ( ctx: CanvasRenderingContext2D,allPlayersStats: {name: string, remainingMeeples: number, color: string, points: number}[], clickableElements: { name: string, color: string }[] ) => {
    ctx.font = '80px serif';
